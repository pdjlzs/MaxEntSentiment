...
void Labeler::train(const string& trainFile, const string& devFile,
	...
	m_classifier.init(m_labelAlphabet.size(), m_featAlphabet.size(), m_options.hiddenSize1, m_options.hiddenSize2);
